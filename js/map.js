...
var arrayAd = [author, offer, mapLocation];
...
for (var i = 0; i < 6; i++) {
  ...
  element.content.querySelector('.pin_location_x').textContent = mapLocation.x;
  element.content.children[0].querySelector('.pin_location_y').textContent = mapLocation.y;
